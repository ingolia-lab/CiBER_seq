...
for (annot in c("aabiosynthesis_handcur", "polIIIsubunit_handcur", "transcription_handcur", 
                ...
                "actin_extra_handcur", "proteasome_handcur", "ribosomal_subs_handcur", 
                "ER_traff_handcur", "mitochondrial_handcur")){
  x <- read.table(paste(GOpath, annot, ".txt", sep=""),
                  stringsAsFactors=FALSE, header = TRUE)
  assign(paste(annot, sep=""), x)
  for (dir_file in c("HIS4_PGK1_pooled/his4_pooled_sum_mpralm")){
...
pdf("his4_pool_inset.pdf", useDingbats=FALSE, width=5, height=5, colormodel="rgb")
...
points(-pmin(4, actin_extra_handcurhis4_pooled$logFC),
       -log10(pmax(10^-15, actin_extra_handcurhis4_pooled$adj.P.Val)),
       type="n",
       col="green4"
)
points(-pmin(4, proteasome_handcurhis4_pooled$logFC),
       -log10(pmax(10^-15, proteasome_handcurhis4_pooled$adj.P.Val)),
       type="n",
       col="khaki3"
)
points(-pmin(4, ribosomal_subs_handcurhis4_pooled$logFC),
       -log10(pmax(10^-15, ribosomal_subs_handcurhis4_pooled$adj.P.Val)),
       type="n",
       col="lightpink3"
)
points(-pmin(4, ER_traff_handcurhis4_pooled$logFC),
       -log10(pmax(10^-15, ER_traff_handcurhis4_pooled$adj.P.Val)),
       type="n",
       col="saddlebrown"
)
#points(-pmin(4, mitochondrial_handcurhis4_pooled$logFC),
#       -log10(pmax(10^-15, mitochondrial_handcurhis4_pooled$adj.P.Val)),
#       type="n",
#       col="maroon"
#)
...
pointsfile <- "his4_pool_inset.png"
