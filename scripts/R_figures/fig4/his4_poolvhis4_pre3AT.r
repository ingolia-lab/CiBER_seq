...
his4_postv3AT <- read.delim(paste(mpralmpath, "HIS4_PGK1_3AT/his4_prev3AT_sum_mpralm", ".txt", sep=""),
                  stringsAsFactors=FALSE, header = TRUE)
#note that his4_postv3AT actually calls his4_prev3AT
...
pdf("new_hispoolvsprev3AT.pdf", useDingbats=FALSE, width=8.5, height=8.5, colormodel="rgb")
...
pointsfile <- "his4_pooled_vsprev3AT.png"
