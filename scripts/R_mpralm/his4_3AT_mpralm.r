...
write.table(pgk1_sum_mpralm, "~/CiBER_seq_package/all_raw_fasta_gz/HIS4_PGK1_3AT/pgk1_postv3AT_sum_mpralm.txt", sep="\t")
write.table(his4_sum_mpralm, "~/CiBER_seq_package/all_raw_fasta_gz/HIS4_PGK1_3AT/his4_postv3AT_sum_mpralm.txt", sep="\t")
