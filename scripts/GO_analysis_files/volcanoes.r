...
plot(x = pgk1_pooled$LFC_plot, y = pgk1_pooled$sig_plot,
     ...
     ylab = expression('Statistical Significance -log10(Q)'), 
     col="gray52")
points(-transcription_handcurpgk1_pooled$logFC,
       -log10(pmax(10^-20, transcription_handcurpgk1_pooled$adj.P.Val)),
       type="n",
       col="firebrick"
)
points(-glycolysis_handcurpgk1_pooled$logFC,
       -log10(pmax(10^-20, glycolysis_handcurpgk1_pooled$adj.P.Val)),
       type="n",
       col="steelblue2"
)
#rect(-6,0,6,-log10(0.05), col = alpha("gray52", 0.3))
...
plot(x = his4_postv3AT$LFC_plot, y = his4_postv3AT$sig_plot,
     ...
     ylab = expression('Statistical Significance -log10(Q)'), 
     col="gray52")
points(-transcription_handcurhis4_postv3AT$logFC,
       -log10(pmax(10^-20, transcription_handcurhis4_postv3AT$adj.P.Val)),
       type="n",
       col="firebrick"
)
points(-aabiosynthesis_handcurhis4_postv3AT$logFC,
       -log10(pmax(10^-20, aabiosynthesis_handcurhis4_postv3AT$adj.P.Val)),
       type="n",
       col="violet"
)
points(-polIIIsubunit_handcurhis4_postv3AT$logFC,
       -log10(pmax(10^-20, polIIIsubunit_handcurhis4_postv3AT$adj.P.Val)),
       type="n",
       col="palegreen3"
)
points(-tRNAprocessing_handcurhis4_postv3AT$logFC,
       -log10(pmax(10^-20, tRNAprocessing_handcurhis4_postv3AT$adj.P.Val)),
       type="n",
       col="paleturquoise"
)
points(-tRNAaasynthetase_handcurhis4_postv3AT$logFC,
       -log10(pmax(10^-20, tRNAaasynthetase_handcurhis4_postv3AT$adj.P.Val)),
       type="n",
       col="seagreen4"
)
points(-translationcontrol_handcurhis4_postv3AT$logFC,
       -log10(pmax(10^-20, translationcontrol_handcurhis4_postv3AT$adj.P.Val)),
       type="n",
       col="royalblue1"
)
#rect(-6,0,6,-log10(0.05), col = alpha("gray52", 0.3))
...
axis(side = 1, at = c(-6, -4, -2, 0, 2, 4, 6), labels=c("<1/64", "1/16", "1/4", "1", "4", "16", ">64"))
axis(side = 2, at = c(0, 5, 10, 15, 20), labels=c("0", "5", "10", "15", ">20"))
title(main="P(His4) Before vs After 3AT Induction")
dev.off()
