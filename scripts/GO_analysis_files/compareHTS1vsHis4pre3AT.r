...
"TRiC_CCT_handcur", "proteasome_handcur", "actin_handcur")){
  ...
  for (dir_file in c("HTS1_RPC31/HTS1_sum_mpralm", "HTS1_RPC31/RPC31_sum_mpralm", 
                     "HIS4_PGK1_pooled/his4_pooled_sum_mpralm", "HIS4_PGK1_3AT/his4_prev3AT_sum_mpralm")){
...
hisprev3AT_sub <- his4_prev3AT[c(1,2,6,9)]
...
names(hisprev3AT_sub) <- c("Guide", "hisprev3AT_logFC", "hisprev3AT_adj.P.val", "hisprev3AT_Yorf1")
...
RPC31vhispre3AT <- merge(RPC31_sub, hisprev3AT_sub, by = "Guide")
RPC31vhispre3AT$diff <- RPC31vhispre3AT$RPC31_logFC - RPC31vhispre3AT$hisprev3AT_logFC
RPC31vhispre3AT_onesig <- filter(RPC31vhispre3AT, 
                                 RPC31vhispre3AT$RPC31_adj.P.val < 0.05 | RPC31vhispre3AT$hisprev3AT_adj.P.val < 0.05)
RPC31vhispre3AT_onesig <- merge(RPC31vhispre3AT_onesig, sgd_sub, by.x = "RPC31_Yorf1", by.y = "name")

HTS1vhispre3AT <- merge(HTS1_sub, hisprev3AT_sub, by = "Guide")
HTS1vhispre3AT$diff <- HTS1vhispre3AT$HTS1_logFC - HTS1vhispre3AT$hisprev3AT_logFC
HTS1vhispre3AT_onesig <- filter(HTS1vhispre3AT, 
                                 HTS1vhispre3AT$HTS1_adj.P.val < 0.05 | HTS1vhispre3AT$hisprev3AT_adj.P.val < 0.05)
HTS1vhispre3AT_onesig <- merge(HTS1vhispre3AT_onesig, sgd_sub, by.x = "HTS1_Yorf1", by.y = "name")
