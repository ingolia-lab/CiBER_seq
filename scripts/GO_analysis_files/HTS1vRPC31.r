...
HTS1_sig <- filter(HTS1vRPC31, HTS1vRPC31$HTS1_adj.P.val < 0.05)
RPC31_sig <- filter(HTS1vRPC31, HTS1vRPC31$RPC31_adj.P.val < 0.05)
both_sig <- filter(HTS1vRPC31, HTS1vRPC31$RPC31_adj.P.val < 0.05 & HTS1vRPC31$HTS1_adj.P.val < 0.05)

pdf("HTS1vRPC31.pdf", useDingbats=FALSE, width=5, height=5, colormodel="rgb")
## Plot with type="n" to skip drawing the points
plot(x = -HTS1vRPC31$HTS1_logFC, y = -HTS1vRPC31$RPC31_logFC,
     type="n",
     axes=FALSE,
     xlim = c(-6,6),
     ylim = c(-6,6), 
